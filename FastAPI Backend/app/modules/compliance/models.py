...
class ComplianceType(Base, TenantBaseModelMixin):
    ...
    cycles: Mapped[list["ComplianceCycle"]] = relationship("ComplianceCycle", lazy="dynamic")
    applicability: Mapped[list["ComplianceApplicability"]] = relationship("ComplianceApplicability", lazy="dynamic")
...
class ComplianceCycle(Base, TenantBaseModelMixin):
    ...
    workflow_stage: Mapped[str | None] = mapped_column(String(100), nullable=True)
    ...
    compliance_type: Mapped["ComplianceType"] = relationship("ComplianceType", lazy="selectin")
    matter: Mapped[Optional["Matter"]] = relationship("Matter", foreign_keys=[matter_id], lazy="selectin")
    matters: Mapped[Optional["Matter"]] = relationship("Matter", foreign_keys="Matter.compliance_cycle_id", lazy="selectin")
...
class ComplianceApplicability(Base, TenantBaseModelMixin):
    ...
    custom_frequency: Mapped[ComplianceFrequency | None] = mapped_column(Enum(ComplianceFrequency), nullable=True)
